...
\begin{lemma}\label{lm:many_edges}
    ...
    \begin{proof}
        ...
        If $\frac{3}{\sqrt{n}} \leq d \leq 3 \sqrt{\frac{\log n}{n}}$,
        by Remark~\ref{rm:min_d},
        we get
        \[
            18 \leq nd^2
            < 6t \leq
...
Finally, we need to show that the algorithm returns a balanced $k$-partite $k$-subgraph
for our base case, that is, the case that does not make any recursive calls.
This is when $k=2$.
