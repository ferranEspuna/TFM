...
\begin{proof}[Proof of the Erdős-Stone-Simonovits Theorem]
    ...
    there are $\Omega\left(n^{p}\right)$ copies of $\completesuperindex{2}{p}$ in $H_n$,
    ...
    Say, for example, that $H_n'[V_1 \cup \dots \cup V_p] = \compdots{V_1}{V_p}$, with $V_i = t$.
    Whe have that $(v_1, \dots, v_p)$ is an edge of $H_n'$
    for all $\in V_1 \times \dots \times V_p$.
    In particular, if $i \neq j$, $\{v_i, v_j\} \in E_n$.
    This means that $H_n[V_1 \cup \dots \cup V_p] = \compdotssuperindex{2}{V_1}{V_p} \cong G'$,
