...
% TODO refactor (k-1)-link
% TODO what if we do not restrict the edges to have exactly one vertex in W?
...
\subsection{Algorithm for $k$-graphs} \label{subsec:algorithm-for-k-graphs}
