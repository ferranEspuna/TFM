...
\begin{lemma}\label{lm:return}
    ...
    \begin{proof}
        ...
        \begin{align*}
            ...
            \leq & \, dn^{\frac{k-1}{t}} w \binom{n}{k-1}^{1-1/t} + t \binom{n}{k-1} \leq
             dn^{\frac{k-1}{t}} wn^{(k-1)(1-1/t)} + tn^{k-1} \leq \\
            \leq & \, dn^{\frac{k-1}{t}} wn^{(k-1)(1-1/t)} + \frac{1}{2} dwn^{k-1} =
            \frac{3}{2} dwn^{k-1},
        \end{align*}
        where the last inequality follows from $w = \lceil 2t/d \rceil$.
