...
The implementation of the algorithm and its proof of correctness is less cumbersome if we assume
...
afterwards if desired to be balanced of part sizes $t$.
