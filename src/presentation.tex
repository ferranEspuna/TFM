...
\begin{frame}[fragile]
    ...
    \begin{adjustwidth}{-0.5cm}{0cm} % Pulls left margin in by 1.5cm, right margin is unchanged
        ...
        % Your figure is here. The \centering command is still useful
        % to center the figure within the NEW, wider text block.
        \begin{figure}
            \centering
            % I've slightly increased the scale since we have more room now. Adjust as needed.
            \scalebox{0.6}{
