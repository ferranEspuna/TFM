...
\end{equation}
Running a greedy search on all sets of $kt$ vertices in $H$ would yield a polynomial-time algorithm,
...
can be show by probabilistic arguments (see~\Cref{prop:probabilistic-lower-bound} and
