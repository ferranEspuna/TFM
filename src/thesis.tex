...
\agraiments{
    ...
    and for all the gentle nudges away from local optima, no matter how much I resisted them at the time.
    ...
    It really was about the friends we make along the way.
