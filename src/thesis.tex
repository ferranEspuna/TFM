...
\usepackage{algpseudocode} % Or \usepackage{algorithmic} for the older style
...
\titol{Finding Partite Graphs Efficiently}
\titolcurt{Finding Partite Graphs Efficiently}
