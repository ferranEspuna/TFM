...
\[
    t (n, d, k) = \left\lfloor \left(  \frac{\log (n/2^{k-2})}{\log (2^{k-1}/d)} \right)^{\frac{1}{k-1}} \right\rfloor
\]
...
\begin{lemma}
    ...
    \begin{proof}
        ...
        Because we have positive density this implies $n = k = 2$, with at most one edge, which clearly
        does not satisfy the density condition.

        % TODO correctness starts here.
