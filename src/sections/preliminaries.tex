...
For example, the complete $3$-partite $2$-graph $K^{(2)}(2, 2, 2)$, shown in~\Cref{fig:k2_222},
...
More concretely, the complete $k$-graph $\compoverset{k}{t}$ (see~\Cref{fig:222} for an example)
