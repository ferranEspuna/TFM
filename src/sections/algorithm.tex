...
We will now state the main theorem of this dissertation, which is a generalization of the above algorithm.
...
\begin{lemma}\label{lm:sound}
    ...
    \begin{proof}
        ...
        \]
        which is false for all $n > 2$. % TODO show this
...
\begin{lemma}\label{lm:base_case}
    ...
    \begin{proof}
        ...
        \[
            t > \left\lfloor d^t n  \right\rfloor \implies
            t >
            d^t n \geq
...
\begin{lemma}
    ...
    \begin{proof}
        ...
        and the right hand side is increasing in $d$ for $d \leq 1$. % TODO show this
