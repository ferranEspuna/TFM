...
\begin{definition}
    ...
    The \emph{common $j$-link graph} of $S$ is the $j$-graph $\link{G}{S}{j} = (V \setminus S, E')$, where
    \[
...
\begin{theorem}\label{thm:erdos64}
    ...
    \begin{proof}
        ...
        Consider, for each set $T \in \binom{W_k}{t}$, the associated $(k-1)$-link $G_T$.
        By our assumption, $G_T$ does not contain $\compoverset{k-1}{t}$ as a subgraph.
        If we let
        \[
