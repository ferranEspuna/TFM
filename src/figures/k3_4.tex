...
\draw[line width=1.5pt, color=blue!70!white] (R0) -- (V1);
\draw[line width=1.5pt, color=blue!70!white] (R0) -- (V2);
\draw[line width=1.5pt, color=blue!70!white] (R0) -- (V3);
\fill[color=blue!70!white] (R0) circle (2.5pt);
\coordinate (R1) at (1.500, 3.500);
\draw[line width=1.5pt, color=blue!70!white] (R1) -- (V1);
\draw[line width=1.5pt, color=blue!70!white] (R1) -- (V2);
\draw[line width=1.5pt, color=blue!70!white] (R1) -- (V4);
...
\draw[line width=1.5pt, color=blue!70!white] (R3) -- (V2);
\draw[line width=1.5pt, color=blue!70!white] (R3) -- (V3);
\draw[line width=1.5pt, color=blue!70!white] (R3) -- (V4);
