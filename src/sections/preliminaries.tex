...
\begin{remark}\label{rem:zar_vs_turan}
    ...
    \[ex(n, K(t_1, \overset{k}{\cdots}, t_k)) = O_n(z(\lceil n / k \rceil , \overset{k}{\cdots}, \lceil n / k \rceil; t_1, \dots, t_k)).\]
...
\begin{theorem}\label{thm:erdos64}
    $ex(n, K(t, \overset{k}{\cdots}, t)) = O_n\left(n^{k - \frac{1}{t^{k-1}}}\right)$.
    \begin{proof}
        By Remark~\ref{rem:zar_vs_turan}, it suffices to show that
        \[
            z = z(w, \overset{k}{\cdots}, w; t, \overset{k}{\cdots}, t) = O_w\left(w^{k - \frac{1}{t^{k-1}}}\right).
        \]
        ...
        $|W_i| = w \geq w_0$ and ${|E| \geq K w^{k - \frac{1}{t^{k-1}}}}$ such that no embedding of $K(t, \overset{k}{\cdots}, t)$ in it exists.
        Consider, for each set $T \in \binom{W_k}{t}$, the associated joint link $G_T$.
        By our assumption, $G_T$ does not contain $K(t, \overset{k-1}{\cdots}, t)$ as a subgraph.
        If we let
        \[
            z' = z(w, \overset{k-1}{\cdots}, w; t, \overset{k-1}{\cdots}, t),
        \]
        ...
        ${s = z' + 1}$ to get
        \[
            K w^{k - \frac{1}{t^{k-1}}} \leq |E| = |E'| \leq (z')^{1 / t}(w - t + 1)w^{(k-1)(1 - 1 / t)} + (t - 1)w^{k-1}.
        \]
        % TODO
