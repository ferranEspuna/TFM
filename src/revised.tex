...
\begin{document}
    ...
    \begin{remark} \label{rk:order}
        ...
        $H$ is a $k$-uniform hypergraph with $n$ vertices and at least $d \binom{n}{k}$ edges, $H$ contains $\compoverset{k}{t}$
    ...
    the constant factor obtained by our algorithm is smaller than that guaranteed by probabilistic existence proofs
    (for example, we do not have $c(d, k) \to \infty$ as $d \to 1$).
