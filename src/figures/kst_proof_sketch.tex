...
\uncover<13>{
  \node[draw, thick, fill=yellow!20, rounded corners, align=center, text width=6.0cm, overlay] at (2.25, -1.5) {{In the example, we conclude that $10.4 \leq 12$, which is true. For bigger values of $z$ this would fail, leading to contradiction and therefore upper bounding $z$.}};
}
