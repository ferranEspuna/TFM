...
\begin{enumerate}
    ...
    The proofs of correctness for~\Cref{alg:kpartite}, particularly~\Cref{lm:many_edges,lm:return,lm:t_prime,lm:base_case},
    ...
    $t(n,d,k)$ or relax the minimum density requirements (\Cref{rm:min_d}).
    ...
    This approach taken in the proof of~\Cref{thm:erdos64}
    ...
    There are versions of~\Cref{thm:erdos64-constant-density}
    ...
    This shows that~\Cref{alg:kpartite} may not return a complete balanced $k$-partite
    ...
    As discussed in~\Cref{thm:quant-blowup}, $k$-graphs with density $\pi(G) + \epsilon$
    ...
    Implementing~\Cref{alg:kpartite}
